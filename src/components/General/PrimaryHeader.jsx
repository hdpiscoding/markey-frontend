...
const PrimaryHeader = (props) => {
    ...
    const handleSearch = (event) => {
        ...
        if (search.trim() !== '') {
            navigate(`/shopper/search-products/${encodeURIComponent(search)}`);
        }
    }
    ...
    return (
        <>
            <header
                className="bg-gradient-to-b from-Blue to-Light_blue grid grid-cols-[1fr_10fr_1fr] w-screen h-auto select-none sticky top-0 z-50">
                            ...
                            <div className="flex items-center justify-center">
                                <div>
                                    <input className="h-[2rem] w-[40rem] outline-none rounded-l-md relative pl-3"
                                           value={search} onChange={handleSearchChange} onKeyDown={handleKeyDown}/>
                                </div>

                                <div
                                    className="bg-White rounded-r-md w-[4rem] h-[2rem] flex items-center justify-center">
                                    <div
                                        className="bg-Blue flex items-center justify-center w-[3.5rem] h-[1.5rem] rounded-md">
