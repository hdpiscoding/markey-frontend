...
const SalemansOrderItem = (props) => {
    ...
    return (
        <div className="bg-White flex flex-col gap-3 shadow">
            <div className="grid grid-cols-[85%_15%] pr-4">
                <div className="flex gap-4 col-start-1">
                    <div>
                        <img src={props.picture} alt="product_img" className="object-cover h-[100px] w-[100px]"/>
                    </div>
                ...
                <div className="flex items-center justify-end">
                    <span className="font-semibold text-pretty text-xl text-Red">
                        đ {formatNumberWithDots(props.price * props.quantity)}
                    </span>
                </div>
            </div>
        </div>
