...
const SearchProduct = () => {
    ...
    // set filter when the page is loaded
    useEffect(() => {
                ...
                <div className="col-start-2 flex flex-col gap-4">
                    {products.length === 0
                        ...
                        <div className="flex flex-col items-center my-20">
                            ...
                            <span className="text-lg text-Dark_gray">
                                Không tìm thấy sản phẩm nào với từ khóa "{decodedProductName}"
                            </span>
                        </div>
                        :
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="grid grid-cols-[22%_1%_77%]">
                                <Filter onFilterByPrice={handleFilterByPrice} onFilterByRating={handleFilterByRating}
