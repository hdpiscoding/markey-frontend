                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td className="py-5 relative">
                                    ...
                                    {errors.newPassword && (
                                        <p className="text-red-500 flex text-sm items-center absolute left-0">
                                            <BiErrorCircle className="mr-1 h-3 w-3"/>
                                            {errors.newPassword}
                                        </p>
                                    )}
                            ...
                            <tr>
                                ...
                                <td className="py-5 relative">
                                    ...
                                    {errors.confirmPassword && (
                                        <p className="text-red-500 flex items-center text-sm absolute left-0">
                                            <BiErrorCircle className="mr-1 h-3 w-3"/>
                                            {errors.confirmPassword}
                                        </p>
                                    )}
...
export default SalesmanChangePassword;